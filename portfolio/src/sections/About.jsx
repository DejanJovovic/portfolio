...
const About = () => {
    ...
    // copy to clipboard my email
    const handleCopy = () => {
        navigator.clipboard.writeText('dejan.jovovic2002@gmail.com');

        setHasCopied(true);

        // reset the setHasCopied to false after 2000 seconds, so it can be copied again
        setTimeout(() => {
            setHasCopied(false);
        }, 2000)
    }
                    ...
                    <div className="grid-container">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="copy-container" onClick={handleCopy}>
                                ...
                                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">dejan.jovovic2002@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
