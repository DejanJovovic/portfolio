...
// counts how many projects there are in myProjects
...
const Projects = () => {
    ...
    // handles scrolling to projects with arrows
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
                ...
                py-10 px-5 shadow-2xl shadow-black-200">
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-5">
                        ...
                        <a className="flex items-center gap-2 cursor-pointer text-white-600"
                           // target means that it opens a new page for the portfolio
                    ...
                    {/*container for arrows to scroll projects*/}
                ...
                <div className="border border-black-300 bg-black-200 rounded-lg h-96 md:h-full">
                    <Canvas>
                        ...
                        {/*centers something on the screen*/}
                        <Center>
                            {/*shows something while its currently loading*/}
                            <Suspense fallback={
                                <CanvasLoader/>
                            }>
