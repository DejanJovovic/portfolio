...
export const calculateSizes = (isSmall, isMobile, isTablet) => {
    return {
        ...
        cubePosition: isSmall ? [4, -5, 0] : isMobile ? [5.5, -3.5, 0] : isTablet ? [6, -4, 0] : [9, -4.5, 0],
        reactLogoPosition: isSmall ? [3, 4, 0] : isMobile ? [5, 2, 2] : isTablet ? [5, 1, 3] : [7, 1, 0],
        ringPosition: isSmall ? [-5, 7, 0] : isMobile ? [-24, 14, 0] : isTablet ? [-27, 10, 0] : [-29, 10, 0],
